                            ...
                            if($products){
                                foreach($products as $product){
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td > 
                                        <div>
                                        <a type="button" class="btn btn-primary btn-sm" href="<?=VIEW?>product/restore.php?id=<?php echo $product['id']?>"><i class="fas fa-trash-restore-alt"></i></a></div>
                                ...
                                <tr class="text-center">
                                    <td colspan="5">
                                        There is no product in trash box. 
                                    </td>
                                </tr>
                                <?php
                            }
