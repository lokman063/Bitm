<nav class="col-md-2 d-none d-md-block bg-light sidebar">
    <div id="" class="sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=VIEW;?>admins/index.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=VIEW;?>cart/index.php">
                    <span data-feather="shopping-cart"></span>
                    Cart
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=VIEW;?>testimonials/index.php">
                    <span data-feather="shopping-cart"></span>
                    Testimonials
                </a>
                            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=VIEW;?>sponser/index.php">
                    <span data-feather="shopping-cart"></span>
                    Sponser
                </a>
            </li>
