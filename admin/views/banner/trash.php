                            ...
                            if($banners){
                                foreach($banners as $banner){
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td > <a type="button" class="btn btn-primary btn-sm" href="<?=VIEW?>banner/restore.php?id=<?php echo $banner['id']?>">Restore</a>
                                             <p> </p>
                                             <p> </p>
                                            <form action="<?=VIEW?>banner/delete.php" method="post">
                                                <input type="hidden" name="id" value="<?php echo $banner['id'];?>">
                                                <input type="hidden" name="picture" value="<?php echo $banner['picture'];?>">
